...
class ManagerServiceTest {
    ...
    @Test
    public void manager_목록_조회_시_Todo가_없다면_ManagerException_에러를_던진다() {
        // given
        long todoId = 1L;
        given(todoRepository.findById(todoId)).willReturn(Optional.empty());

        // when & then
        ManagerException exception = assertThrows(ManagerException.class, () -> managerService.getManagers(todoId));
